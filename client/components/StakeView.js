...
export default class StakeView extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      ...
      prevProps.rewardPeriod.totalStaked !== this.props.rewardPeriod.totalStaked
    ) {
      this.setState({
        ...
        rewardPeriod: this.props.rewardPeriod,
      });
    }
  }
  ...
  render() {
    ...
    const mySharePerc =
      lpStaked && this.state.rewardPeriod.totalStaked > 0
        ? Math.round((lpStaked * 10000) / this.state.rewardPeriod.totalStaked) /
          100
        : "0";
      ...
      <div>
        <Wrapped>
          <Card style={{ flex: 1, minWidth: 200, margin: 10 }}>
            ...
            <Card.Body> {this.state.rewardPeriod.totalStaked} ETB </Card.Body>
          </Card>
          <Card style={{ flex: 1, minWidth: 200, margin: 10 }}>
